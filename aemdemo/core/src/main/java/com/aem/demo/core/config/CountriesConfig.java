...
@ObjectClassDefinition(name="AEM DEMO - Countries JSON configuration",
...
public @interface CountriesConfig {
    ...
    public String jsonPath() default "/content/aemdemo/us";
    ...
    public String authorsPath() default "/content/aemdemo/us";
}
